E = [210e9,210e9]; q = 0; P = 0; M = 0; density = [7850,7850];b = [0.05,0.05]; h = [0.01,0.01]; I =b.*(h.^3)/12;
...
plot(linspace(5,100,96),Amp_rms);
xlabel('Frequency Applied(Hz)'); ylabel('RMS Amplitude(mm)');
